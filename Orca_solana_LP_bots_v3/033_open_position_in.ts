// Open LP position on Orca DEX (concentrated liquidity V3)
// 033:  Use openPosition method instead of openPositionWithMetadata method
// 034:  Use openPositionWithMetadata
...
async function main() {
  ...
  // Get SOL/USDC whirlpool with 0.04 fee and tickspacing 4
  ...
  // Set percentage for the price range
